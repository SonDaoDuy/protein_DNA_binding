...
class CustomDatasetDataLoader:
    def __init__(self, opt, is_for_train=True, is_for_val=False):
        self._opt = opt
    ...
    def _create_dataset(self):
        self._dataset = DatasetFactory.get_by_name(self._opt.dataset_mode, self._opt, self._is_for_train, self._is_for_val)
