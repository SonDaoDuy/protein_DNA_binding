...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self._parser.add_argument('--total_epoch', type=int, default=50, help='# of epochs to linearly decay learning rate to zero')
        self._parser.add_argument('--threshold', type=float, default=0.1, help='threshold to decide a positive sample')
