...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self._parser.add_argument('--data_file', type=str, default='data_dna.pkl', help='file containing samples aus')
        ...
        self._parser.add_argument('--model', type=str, default='DNA_model', help='model to run[au_net_model]')
