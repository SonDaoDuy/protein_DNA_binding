...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self._parser.add_argument('--test_ids_file', type=str, default='val_ids.csv', help='file containing test ids')
        self._parser.add_argument('--data_file', type=str, default='train_data_dna.txt', help='file contain training samples')
        self._parser.add_argument('--label_file', type=str, default='train_label_dna.txt', help='file containing training labels')
        self._parser.add_argument('--val_data_file', type=str, default='val_data_dna.txt', help='file containing val samples')
        self._parser.add_argument('--val_label_file', type=str, default='val_label_dna.txt', help='file containing val labels')
        self._parser.add_argument('--test_data_file', type=str, default='test_data_dna.txt', help='file containing test samples')
        self._parser.add_argument('--test_label_file', type=str, default='test_label_dna.txt', help='file containing test labels')
        ...
        self._parser.add_argument('--seq_size', type=int, default=20, help='input image size')
        #self._parser.add_argument('--cond_nc', type=int, default=17, help='# of conditions')
        self._parser.add_argument('--gpu_ids', type=str, default='', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
        ...
        self._parser.add_argument('--dataset_mode', type=str, default='dna', help='chooses dataset to be used')
        self._parser.add_argument('--model', type=str, default='DNA_model_v2', help='model to run[au_net_model]')
